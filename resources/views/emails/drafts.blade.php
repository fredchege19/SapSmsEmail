...
<div id="invoiceholder">
  ...
  <div id="invoice" class="effect2">
    ...
    <div class="headDoc">
            <div class="subtotal" style="float:right; font-size: 1.3em; margin-top:-4%"><h2>Delivery Note: 5262</h2></div>
    </div>
    <div class="message" style="padding:15px">
    <p>Hello,<br>
Your goods have been dispatched and you should expect your delivery by 5pm today. item(s) have dispatched</p>
    </div>
